...
urlpatterns = [
    ...
    path('table-contact/', dash_view.TablecontactView.as_view(), name='tablecontact'),
    ...
    path('table-success/', dash_view.TablesuccessView.as_view(), name='tablesuccess'),
    ...
    path('table-agent/', dash_view.TableagentView.as_view(), name='tableagent'),
